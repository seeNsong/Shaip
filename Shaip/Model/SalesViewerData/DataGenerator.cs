...
namespace Demo.Blazor.Model.SalesViewer {
    ...
    public class SalesViewerDataGenerator {
        ...
        class SeedDataTaskWrapper<T> : SeedDataTaskWrapper where T : class {
            ...
            public SeedDataTaskWrapper(SalesViewerDataGenerator generator, Func<SalesViewerContext, List<T>> getTable, Func<Task<List<T>>> getSeedFunc) {
                List<T> data = null;
        ...
        public SalesViewerDataGenerator MapTableToSeedMethod<T>(Func<SalesViewerContext, List<T>> table, Func<SalesViewerDataGenerator, Task<List<T>>> seed)
            where T : class {
        ...
        public async Task<List<Product>> CreateProducts() {
            ...
            result.Add(new Product() {
                ...
                BaseCost = 1150, ListPrice = 2250, UnitsInInventory = 67, PlantId = 6, ProjectManagerId = 11, SupportManagerId = 12,
        ...
        public async Task<List<Customer>> CreateCustomers() {
            ...
            result.Add(new Customer { FullName = "Johnson & Assoc", Address = "2379 Broadway", CityId = 1, Zip = "10024", Fax = "(718) 917-6839", Phone = "(718) 917-6839" });
            result.Add(new Customer { FullName = "McCord Builders", Address = "10756 Ashton Ave", CityId = 2, Zip = "90024", Fax = "(410) 418-9108", Phone = "(410) 418-9108" });
            result.Add(new Customer { FullName = "Building Management Inc", Address = "107 S State St", CityId = 3, Zip = "60603", Fax = "(773) 260-8071", Phone = "(773) 260-8071" });
            result.Add(new Customer { FullName = "System Integrators", Address = "5215 W 34th St", CityId = 4, Zip = "77092", Fax = "(707) 220-9114", Phone = "(707) 220-9114" });
            result.Add(new Customer { FullName = "Discovery Systems", Address = "2620 Dean Rd", CityId = 5, Zip = "32216", Fax = "(847) 371-1555", Phone = "(847) 371-1555" });
            result.Add(new Customer { FullName = "Arthur & Sons", Address = "2331 Lewis Ave", CityId = 6, Zip = "59101", Fax = "(561) 843-3972", Phone = "(561) 843-3972" });
            result.Add(new Customer { FullName = "Smith & Co", Address = "1823 SW Spring St", CityId = 7, Zip = "97201", Fax = "(973) 312-3977", Phone = "(973) 312-3977" });
            result.Add(new Customer { FullName = "Beacon Systems", Address = "1435 Wazee St #102", CityId = 8, Zip = "80202", Fax = "(567) 644-4728", Phone = "(567) 644-4728" });
            result.Add(new Customer { FullName = "Gemini Stores", Address = "1401 S May Ave", CityId = 9, Zip = "73108", Fax = "(817) 308-0853", Phone = "(817) 308-0853" });
            result.Add(new Customer { FullName = "Columbia Solar", Address = "1933 Shearwood Forest Drive", CityId = 10, Zip = "95126", Fax = "(860) 205-1690", Phone = "(860) 205-1691" });
            result.Add(new Customer { FullName = "Renewable Supplies", Address = "484 Broome St", CityId = 1, Zip = "10002", Fax = "(804) 615-5863", Phone = "(804) 615-5863" });
            result.Add(new Customer { FullName = "Supply Warehous", Address = "2239 W 29th Pl", CityId = 2, Zip = "90018", Fax = "(315) 924-8962", Phone = "(315) 924-8962" });
            result.Add(new Customer { FullName = "Get Solar Inc", Address = "500 W Madison St", CityId = 3, Zip = "60606", Fax = "(954) 718-3876", Phone = "(954) 718-3876" });
            result.Add(new Customer { FullName = "Solar Warehouse", Address = "1510 Polk St", CityId = 4, Zip = "77002", Fax = "(775) 202-0360", Phone = "(775) 202-0360" });
            result.Add(new Customer { FullName = "Green Energy Inc", Address = "6045 Greenland Rd", CityId = 5, Zip = "32256", Fax = "(541) 286-0792", Phone = "(541) 286-0792" });
            result.Add(new Customer { FullName = "Energy Systems", Address = "PO Box 31156", CityId = 6, Zip = "59116", Fax = "(724) 255-0997", Phone = "(724) 255-0997" });
            result.Add(new Customer { FullName = "Apollo Inc", Address = "1221 SW Yamhill St", CityId = 7, Zip = "97204", Fax = "(804) 264-8719", Phone = "(804) 264-8713" });
            result.Add(new Customer { FullName = "Mercury Solar", Address = "851 S Santa Fe Ave", CityId = 8, Zip = "80292", Fax = "(731) 451-8686", Phone = "(731) 451-8686" });
            result.Add(new Customer { FullName = "Global Services", Address = "8300 Greystone Ave", CityId = 9, Zip = "73116", Fax = "(916) 992-6492", Phone = "(916) 992-6492" });
            result.Add(new Customer { FullName = "Market Eco", Address = "1602 The Alameda # 1013", CityId = 10, Zip = "95126", Fax = "(619) 946-9413", Phone = "(619) 946-9413" });
            result.Add(new Customer { FullName = "Environment Solar", Address = "185 Columbus Ave", CityId = 1, Zip = "10023", Fax = "(601) 534-6561", Phone = "(601) 534-6561" });
            result.Add(new Customer { FullName = "Health Plus Inc", Address = "8001 Sunset Blvd", CityId = 2, Zip = "90046", Fax = "(603) 214-8741", Phone = "(603) 214-8741" });
            return await Task.FromResult(result);
        }
        ...
        public async Task<List<Contact>> CreateContacts() {
            ...
            result.Add(new Contact() { FullName = "John Smith", CityId = 63, Address = "188 Market Street", Zip = "00098", Phone = "(212) 555-2321", Email = "jsmith@harrisburg.com" });
            result.Add(new Contact() { FullName = "Jeff Hall", Email = "jeffh@harrisburg.com" });
            result.Add(new Contact() { FullName = "Kent Hardy", CityId = 62, Address = "1445 Las Vegas Blvd", Zip = "89120", Phone = "(702) 555-2321", Email = "khardy@lasvegas.com" });
            result.Add(new Contact() { FullName = "Brent Moffat", Email = "brentf@lasvegas.com" });
            result.Add(new Contact() { FullName = "Jenny James", CityId = 2, Address = "8247 Sunset Blvd", Zip = "90020", Phone = "(415) 555-2321", Email = "jennyj@losangeles.com" });
            result.Add(new Contact() { FullName = "Carter Smith", Email = "carterc@losangeles.com" });
            result.Add(new Contact() { FullName = "Dirk Porter", Address = "4242 Hill Street", CityId = 64, Zip = "90311", Phone = "(415) 555-2321", Email = "dirkp@sanfran.com" });
            result.Add(new Contact() { FullName = "Angela Vega", Email = "angelav@sanfran.com" });
            result.Add(new Contact() { FullName = "Paul Heart", CityId = 1, Address = "628 Broadway", Zip = "00092", Phone = "(212) 555-2321", Email = "paulh@nyc.com" });
            result.Add(new Contact() { FullName = "Karen McCarthy", Email = "karenm@nyc.com" });
            result.Add(new Contact() { FullName = "Mike Arthur", CityId = 60, Address = "289 Olympic Road", Zip = "20092", Phone = "(404) 555-2321", Email = "mikea@atl.com" });
        ...
        public async Task<List<City>> CreateCities() {
            ...
            result.Add(new City() { Name = "New York", Latitude = 40.66, Longitude = -74.03, Country = "United States", State = "NY", Map = "usa" });
            result.Add(new City() { Name = "Los Angeles", Latitude = 34.02, Longitude = -118.41, Country = "United States", State = "CA", Map = "usa" });
            result.Add(new City() { Name = "Chicago", Latitude = 41.83, Longitude = -87.73, Country = "United States", State = "IL", Map = "usa" });
            result.Add(new City() { Name = "Houston", Latitude = 29.78, Longitude = -95.38, Country = "United States", State = "TX", Map = "usa" });
            result.Add(new City() { Name = "Jacksonville", Latitude = 30.337, Longitude = -81.66, Country = "United States", State = "FL", Map = "usa" });
            result.Add(new City() { Name = "Billings", Latitude = 45.78, Longitude = -108.56, Country = "United States", State = "MT", Map = "usa" });
            result.Add(new City() { Name = "Portland", Latitude = 45.54, Longitude = -122.65, Country = "United States", State = "OR", Map = "usa" });
            result.Add(new City() { Name = "Denver", Latitude = 39.76, Longitude = -104.85, Country = "United States", State = "CO", Map = "usa" });
            result.Add(new City() { Name = "Oklahoma Cities", Latitude = 35.48, Longitude = -97.47, Country = "United States", State = "OK", Map = "usa" });
            result.Add(new City() { Name = "San Jose", Latitude = 37.29, Longitude = -121.81, Country = "United States", State = "CA", Map = "usa" });
            result.Add(new City() { Name = "Ottawa", Latitude = 45.6, Longitude = -75.7, Country = "Canada", State = "Ontario", Map = "canada" });
            result.Add(new City() { Name = "Winnipeg", Latitude = 49.88, Longitude = -97.14, Country = "Canada", State = "Manitoba", Map = "canada" });
            result.Add(new City() { Name = "Edmonton", Latitude = 53.54, Longitude = -113.49, Country = "Canada", State = "Alberta", Map = "canada" });
            result.Add(new City() { Name = "Vancouver", Latitude = 49.25, Longitude = -123, Country = "Canada", State = "British Columbia", Map = "canada" });
            result.Add(new City() { Name = "Halifax", Latitude = 44.69, Longitude = -63.56, Country = "Canada", State = "Nova Scotia", Map = "canada" });
            result.Add(new City() { Name = "Rio de Janeiro", Latitude = -22.91, Longitude = -43.44, Country = "Brazil", State = "", Map = "" });
            result.Add(new City() { Name = "Buenos Aires", Latitude = -34.61, Longitude = -58.43, Country = "Argentina", State = "", Map = "" });
            ...
            result.Add(new City() { Name = "London", Latitude = 51.5, Longitude = -0.12, Country = "United Kingdom", State = "", Map = "europe" });
            result.Add(new City() { Name = "Berlin", Latitude = 52.52, Longitude = 13.41, Country = "Germany", State = "", Map = "europe" });
            ...
            result.Add(new City() { Name = "Sofia", Latitude = 42.69, Longitude = 23.32, Country = "Bulgaria", State = "", Map = "europe" });
            ...
            result.Add(new City() { Name = "Tokio", Latitude = 35.673343, Longitude = 139.710388, Country = "Japan", State = "", Map = "eurasia" });
            result.Add(new City() { Name = "Beijing", Latitude = 39.9, Longitude = 116.39, Country = "China", State = "", Map = "eurasia" });
            result.Add(new City() { Name = "Jerusalem", Latitude = 31.78, Longitude = 35.2, Country = "Israel", State = "", Map = "eurasia" });
            result.Add(new City() { Name = "Singapore", Latitude = 1.28, Longitude = 103.85, Country = "Malaysia", State = "", Map = "eurasia" });
            result.Add(new City() { Name = "Seoul", Latitude = 37.51, Longitude = 126.98, Country = "South Korea", State = "", Map = "eurasia" });
            result.Add(new City() { Name = "Abu Dhabi", Latitude = 24.47, Longitude = 54.37, Country = "United Arab Emirates", State = "", Map = "eurasia" });
            result.Add(new City() { Name = "Sanaa", Latitude = 15.35, Longitude = 44.2, Country = "Yemen", State = "", Map = "eurasia" });
            result.Add(new City() { Name = "Kuwait Cities(){", Latitude = 29.37, Longitude = 47.98, Country = "Kuwait", State = "", Map = "eurasia" });
            result.Add(new City() { Name = "Dhaka", Latitude = 23.71, Longitude = 90.39, Country = "Bangladesh", State = "", Map = "eurasia" });
            result.Add(new City() { Name = "Ulan Bator", Latitude = 47.91, Longitude = 106.92, Country = "Mongolia", State = "", Map = "eurasia" });
            result.Add(new City() { Name = "Sydney", Latitude = -33.79, Longitude = 150.92, Country = "Australia", State = "", Map = "" });
            result.Add(new City() { Name = "Brisbane", Latitude = -27.47, Longitude = 153.02, Country = "Australia", State = "", Map = "" });
            result.Add(new City() { Name = "Perth", Latitude = -31.96, Longitude = 115.93, Country = "Australia", State = "", Map = "" });
            result.Add(new City() { Name = "Melbourne", Latitude = -37.86, Longitude = 145.08, Country = "Australia", State = "", Map = "" });
            result.Add(new City() { Name = "AdelaIde", Latitude = -34.92, Longitude = 138.58, Country = "Australia", State = "", Map = "" });
            ...
            result.Add(new City() { Name = "Pretoria", Latitude = -25.98, Longitude = 28.21, Country = "South Africa", State = "", Map = "africa" });
            result.Add(new City() { Name = "Cairo", Latitude = 30.05, Longitude = 31.26, Country = "Egypt", State = "", Map = "africa" });
            result.Add(new City() { Name = "Mogadishu", Latitude = 2.05, Longitude = 45.3, Country = "Somalia", State = "", Map = "africa" });
            result.Add(new City() { Name = "AbIdjan", Latitude = 5.34, Longitude = -3.97, Country = "Ivory Coast", State = "", Map = "africa" });
            result.Add(new City() { Name = "Casablanca", Latitude = 33.57, Longitude = -7.58, Country = "Morocco", State = "", Map = "africa" });
            result.Add(new City() { Name = "Cape Town", Latitude = -33.91, Longitude = 18.65, Country = "South Africa", State = "", Map = "africa" });
            result.Add(new City() { Name = "N’Djamena", Latitude = 12.12, Longitude = 15.05, Country = "Chad", State = "", Map = "africa" });
            ...
            result.Add(new City() { Name = "Dakar", Latitude = 14.73, Longitude = -17.38, Country = "Senegal", State = "", Map = "africa" });
            result.Add(new City() { Name = "Atlanta", Latitude = 34.45, Longitude = -84.52, Country = "United States", State = "GA", Map = "usa" });
            result.Add(new City() { Name = "Harrisburg", Latitude = 40.16, Longitude = -76.52, Country = "United States", State = "PA", Map = "usa" });
            result.Add(new City() { Name = "Las Vegas", Latitude = 36.10, Longitude = -115.08, Country = "United States", State = "NV", Map = "usa" });
            result.Add(new City() { Name = "San Francisco", Latitude = 37.47, Longitude = -122.25, Country = "United States", State = "CA", Map = "usa" });
            return await Task.FromResult(result);
        }
    }
}